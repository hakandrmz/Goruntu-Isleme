...
path_file=r"C:\Users\Hakan\imageprocessing\penguins.jpg"
image_1=plt.imread(path_file)
plt.imshow(img_1)
plt.show()
...
display_two_image(image_2,image_3)
