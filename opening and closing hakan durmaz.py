...
path_file=r"C:\Users\Hakan\Adsiz.png"
...
def my_dilation(img_1,mask,morphologyOperation='dilation'):
    ...
    for i in range(1,m-1): # padding process
        for j in range(1,n-1):
            ...
            if(morphologyOperation=='erosion'):
...
img_3=my_dilation(img_8,define_mask_1(),'dilation')  # closing process
img_4=my_dilation(img_9,define_mask_1(),'dilation')
img_5=my_dilation(img_10,define_mask_1(),'dilation')

img_6=my_dilation(img_11,define_mask_1(),'erosion') 
img_7=my_dilation(img_12,define_mask_1(),'erosion')
img_8=my_dilation(img_13,define_mask_1(),'erosion')

plt.figure(figsize=(15,15))
plt.subplot(1,3,1),plt.imshow(img_1)
plt.subplot(1,3,2),plt.imshow(img_13,cmap='gray')
plt.subplot(1,3,3),plt.imshow(img_14,cmap='gray')
plt.show()
...
plt.figure(figsize=(15,15))
plt.subplot(1,3,1),plt.imshow(img_1)
plt.subplot(1,3,2),plt.imshow(img_12,cmap='gray')
plt.subplot(1,3,3),plt.imshow(img_13,cmap='gray')
plt.show()
